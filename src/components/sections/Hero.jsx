    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full flex flex-col items-center justify-center text-center min-h-screen pt-24 md:pt-32">
        ...
        <div className="transform transition-all duration-1500 translate-y-0 opacity-100 w-full flex flex-col items-center justify-center">
          {/* Main Heading */}
          <h1 className="font-display font-bold text-white mb-6 leading-tight text-5xl md:text-7xl lg:text-8xl">
            <span className="block">Authentic Indian</span>
            <span className="block text-transparent bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-5xl md:text-7xl lg:text-8xl">
              Culinary Experience
            </span>
          </h1>

          {/* Subtitle */}
          <p className="text-2xl md:text-3xl text-gray-200 mb-10 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <button className="group bg-gradient-to-r from-orange-400 to-orange-500 hover:from-orange-500 hover:to-orange-600 text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-orange-500/25 min-w-[200px]">
